            ...
            if ($email == '123456') {
                if ($password == 'pass123') {
                    if (isset($_POST['keep_me_login'])) {
                        ...
                        // Redirect user to student_page/student_submissionSched page
                        header("location: student_page/student_submissionSched.php");
                    } else {
                        // Store data in session variables
                ...
                $_SESSION['email'] = "Email or username doesn't exist!";
                $validationEmail = "is-invalid";
            }
                        ...
                        <form method="POST">
                            <div class="mb-2">
                                ...
                                <input type="text" name="email" class="form-control <?php echo $validationEmail; ?>"
                                    value="<?php echo $email; ?>" placeholder="Email or Username">
                                <?php
                                ...
                                <input type="password" name="password"
                                    class="form-control <?php echo $validationPassword; ?>"
                            ...
                            <div class="mb-3">
                                <button type="submit" name="login_btn"
                                    class="btn btn-lg shadow w-100 text-white text-decoration-none"
                                    style="background-color: #B22222;">
                                    <i class="bi-arrow-right"></i> Log In
                                </button>
                                <!-- <a href="./student_page/student_submissionSched.php" type="submit" name="login_btn"
                                    class="btn btn-lg shadow w-100 text-white text-decoration-none"
                                    style="background-color: #B22222;">
                                    <i class="bi-arrow-right"></i> Log In
                                </a> -->
                                <div class="m-3 mt-4 text-center">
                                    ...
                                    <a class="text-center btn btn-sm btn-primary text-decoration-none fw-semibold text-white"
                                        href="requestAccount.php">Request an account.</a>
                                </div>
                            </div>
                        </form>
                    </div>
