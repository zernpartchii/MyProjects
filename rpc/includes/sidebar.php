...
<div id="mySidenav" class="sidenav m-0 bg-light">
    <ul class="px-0">
        ...
        <li class="w-100 dashboard px-2 my-1 d-flex align-items-center">
            <span class="active2 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-speedometer icon fs-5 hover
            d-flex align-items-center" href="dashboard.php">
                <span class="text-dark active-nav2 ms-4 fs-5">Dashboard</span></a>
        </li>
        <li class="w-100 thesis px-2 my-1 d-flex align-items-center">
            <span class="active11 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-bookmark-check-fill icon fs-5 hover
            d-flex align-items-center" href="thesisCompleted.php">
                <span class="text-dark active-nav11 ms-4 fs-5">Thesis Completed</span></a>
        </li>
        <li class="w-100 pending px-2 my-1 d-flex align-items-center">
            <span class="active3 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-file-earmark-text-fill icon fs-5 hover
            d-flex align-items-center" href="pendingRequest.php">
                <span class="text-dark active-nav3 ms-4 fs-5">Pending Request</span></a>
        </li>
        <li class="w-100 schedule px-2 my-1 d-flex align-items-center">
            <span class="active9 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-calendar-check-fill icon fs-5 hover
            d-flex align-items-center" href="scheduleAvailability.php">
                <span class="text-dark active-nav9 ms-4 fs-5">Schedule Availability</span></a>
        </li>
        <li class="w-100 progressControl px-2 my-1 d-flex align-items-center">
            <span class="active10 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-bar-chart-fill icon fs-5 hover
            d-flex align-items-center" href="progressControl.php">
                <span class="text-dark active-nav10 ms-4 fs-5">Progress Control</span></a>
        </li>
        <li class="w-100 reports px-2 my-1 d-flex align-items-center">
            <span class="active4 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-card-heading icon fs-5 hover
            d-flex align-items-center" href="reports.php">
                <span class="text-dark active-nav4 ms-4 fs-5">Reports</span></a>
        </li>
        <li class="w-100 settings px-2 my-1 d-flex align-items-center">
            <span class="active5 py-4"></span>
            <a class="nav-link text-nav ps-2 py-2 w-100 bi bi-gear-fill icon fs-5 hover
        ...
        <li class="w-100 profile px-2 my-1 sidebar_hidden d-flex align-items-center">
