        ...
        <div class="content my-5" method="POST">
            ...
            <div class="text-center">
                ...
                <div class="mb-3 d-flex justify-content-evenly align-items-center">
                    <a href="index.php" name="login_btn" class="btn btn-lg shadow w-50 text-white text-decoration-none"
                        style="background-color: #B22222;">
                        <i class="bi-arrow-right"></i> Log In</a>
                    <p class="mt-3 mx-3 fs-6">OR</p>
                    <a href="register.php" name="register_btn"
                        class="btn btn-lg bg-primary shadow w-50 text-white text-decoration-none">
