...
<div class="row m-0 p-3 w-100">
        ...
        <div class="card border-0 w-100 border-bottom">
            <div class="card-body d-flex align-items-center p-0">
                ...
                <!-- <a href="addResearch.php" class="btn btn-sm mb-2 mx-2 btn-primary"><i class="bi-plus-circle"></i> Add
                    Research</a> -->
                <!-- <a href="reports.php" class="btn btn-sm mb-2 text-white" style="background-color: #E85C0D;"><i
                        class="bi-cloud-download-fill"></i> Generate
                    report</a> -->
            </div>
        </div>
    </div>
    <div class="col-md-3 mb-3">
        <div class="card border-0 shadow-sm pb-2" style="background-color: #821131;">
            <div class="card-header border-0">
                <h5 class="text-white fw-semibold">Department</h5>
            </div>
            <div class="card-body bg-body">
                <div class="fs-6">Total of Department: <?php echo $zone; ?></div>
            </div>
        </div>
    </div>
    <div class="col-md-3 mb-3">
        <div class="card border-0 shadow-sm pb-2" style="background-color: #C7253E;">
            <div class="card-header border-0">
                <h5 class="text-white fw-semibold">
                    Program</h5>
            </div>
            <div class="card-body bg-body">
                <div class="fs-6">Total of Program: <?php echo $program; ?></div>
            </div>
        </div>
    </div>
    <div class="col-md-3 mb-3">
        <div class="card border-0 shadow-sm pb-2" style="background-color: #E85C0D;">
            <div class="card-header border-0">
                <h5 class="text-white fw-semibold">
                    Thesis Title</h5>
            </div>
            <div class="card-body bg-body">
                <div class="fs-6">Total of Thesis Title: <?php echo $title; ?></div>
            </div>
        </div>
    </div>
    <div class="col-md-3 mb-3">
        <div class="card border-0 shadow-sm pb-2" style="background-color: #FABC3F;">
            <div class="card-header border-0">
                <h5 class="text-white fw-semibold">
                    Proponents</h5>
            </div>
            <div class="card-body bg-body">
                <div class="fs-6">Total of Proponents: <?php echo $proponents; ?></div>
            </div>
        </div>
    </div>
  ...
  JOIN Zone z ON z.id = r.Zone ORDER BY z.Zone ASC";
    $result1 = mysqli_query($con, $sql);
