        ...
        <div class="card-body">
            <form method="POST">
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control <?php echo $_firstnameValidation; ?>" id="edit_firstname"
                            value="<?php echo $user_firstname; ?>" name="edit_firstname">
                        <?php
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control <?php echo $_lastnameValidation; ?>" id="edit_lastname"
                            value="<?php echo $user_lastnme; ?>" name="edit_lastname">
                        <?php
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="email" class="form-control <?php echo $_emailValidation; ?>" id="edit_email"
                            value="<?php echo $email; ?>" name="edit_email">
                        <?php
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="password" class="form-control <?php echo $validationPassword; ?>"
                            id="edit_new_password" value="<?php echo $password; ?>" name="edit_new_password">
                        <?php
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="password" class="form-control <?php echo $validationConfirmPassword; ?>"
                            id="edit_confirm_password" value="<?php echo $confirm_password; ?>"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4 mb-1">
                        <div class="d-flex flex-wrap">
                            <button type="submit" name="save_btn"
                                class="form-control bg-primary text-white text-center w-50 fw-semibold text-decoration-none"><i
                                    class="bi-save"></i> Save</button>
                            <a href="profile.php"
                                class="form-control bg-danger text-white text-center w-50 fw-semibold text-decoration-none">
