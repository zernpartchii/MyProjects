            ...
            <form method="POST">
                <div class="d-flex flex-wrap gap-3">
                    <div class="flex-fill">
                        ...
                        <select class="form-select" id="selectZone" name="selectZone" onchange="my_fun(this.value)"
                            required>
                ...
                <div class="mt-3">
                    <button type="submit" name="generateReport" class="btn btn-primary fw-semibold">
