...
<div class="card border-0">
    <div class="card-body">
        <form action="deleteResearch.php" method="POST">
            <div class="mb-3">
                <p class="fs-2 font-monospace border-bottom">PENDING REQUEST</p>
                <a href="#" class="mt-1 btn btn-md btn-primary">
                    <i class="bi bi-check-circle"></i> Generate Account</a>
                <a href="#" class="mt-1 btn btn-md btn-danger">
                    <i class="bi bi-x-circle"></i> Decline</a>
                <!-- <button type="submit" id="btn" name="deleteAll_btn" style="width: 120px;"
                    class="mt-1 btn btn-md btn-danger"><i class="bi-trash"></i> Delete</button> -->
            </div>
            <?php
                ...
                <table id="example" class="table table-hover">
                    ...
                    <tbody class="align-middle">
                        ...
                        ?>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="deleteAll_id[]" class="check_all_id"
                                            value="<?php echo $id; ?>">
                                    </td>
        </form>
        <!-- <td><?php echo $id; ?></td>
        <td class=" text-wrap" style="max-width: 100px;"><?php echo $groupNumber; ?></td> -->
        <td class=" text-wrap" style="max-width: 100px;"><?php echo $zone; ?></td>
        <td class=" text-wrap" style="max-width: 100px;"><?php echo $program; ?></td>
        <td class=" text-wrap" style="max-width: 100px;"><?php echo $title; ?></td>
        ...
        <td class=" text-wrap" style="max-width: 100px;"><?php echo $adviser; ?></td>
        <!-- <td class=" text-wrap" style="max-width: 100px;"><?php echo $stat_da; ?></td> -->
        <td>
            <div class="d-flex">

                <a href="viewResearch.php? viewid='<?php echo $id; ?>'" class="btn btn-md text-primary btn-link mx-1">
                    <i class="bi-eye-fill"></i> More</a>

                <!-- <a href="updateResearch.php? updateid='<?php echo $id; ?>'"
                    class="btn btn-md text-primary btn-link mx-1">
...
<!-- Start Delete Modal -->
<div class="modal fade" id="deleteResearchModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <form action="research.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center fs-5 h6">
                        ...
                        Record ID: <input type="text" class="form-control w-25 ms-3" name="delete_id1" id="delete_id1"
                            disabled>
                    </div>
                </div>
