        ...
        <div class="card-body">
            <form action="">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input type="password" class="form-control" id="password" value="<?php echo $user_pass; ?>"
                            name="password" disabled>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="password" class="col-md-3 form-label"></label>
                    <div class="col-md-4 mb-1">
                        <a href="editProfile.php"
                            class="form-control bg-primary w-50 text-white text-center fw-semibold text-decoration-none"><i
