                ...
                <div class="card border-0 bg-light">
                    <div class="card-body">
                        <form method="POST">
                            ...
                            ?>
                            <h2 class="h3 font-weight-normal my-4">Create Account</h2>
                            ...
                            <div class="form-group my-2">
                                <select class="form-select  border-secondary <?php echo $validationVIP; ?>"
                                    ...
                                    ?>
                                    <option value="none" selected hidden>Select Account Type </option>
                                    <?php
                                    }
                                    ?>
